...
PROMPT_TEMPLATES = {
    ...
    # 知识库问答模板：context是知识库检索出来的相关文档  question是用户提问
    "knowledge_base_chat": {
    ...
    "search_engine_chat": {
        "default": "<指令>这是我搜索到的互联网信息，请你根据这些信息进行提取并有条理，简洁的回答问题。"
    ...
    "agent_chat": {
        ...
        "ChatGLM3": "You can answer using the tools, or answer directly using your knowledge without using the tools. "
